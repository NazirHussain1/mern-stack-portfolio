...
const services = [
  {
    ...
    description: 'Build high-performance, responsive websites with modern front-end architecture and clean UI patterns.',
  ...
  },
  {
    ...
    description: 'Design secure RESTful APIs, integrate databases, and handle authentication with scalable server logic.',
  ...
  },
  {
    ...
    description: 'Connect applications with 3rd-party services, payment gateways, and data APIs for real-world workflows.',
    stack: ['REST APIs', 'Axios', 'OAuth', 'Postman']
  },
  {
    icon: Cpu,
    title: 'AI / ML Support',
    description: 'Integrate intelligent features with AI-powered tooling, data processing, and smart automation flows.',
    stack: ['Python', 'TensorFlow', 'ChatGPT', 'Data Pipelines']
  }
];

const Services = () => {
  return (
    <section id="services" className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 py-24 px-4 text-white sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          ...
          <h2 className="text-4xl font-display font-bold sm:text-5xl">Professional digital services for modern brands.</h2>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-300 sm:text-lg">
            From polished UI development to backend systems and API integration, I help ambitious teams ship reliable web applications with a strong technical foundation.
          </p>
        </motion.div>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                If you need a developer who can move quickly, keep interfaces polished, and make backend systems reliable, I&apos;m ready to help.
              </p>
            </div>
