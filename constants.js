...
export const SUMMARY =
  "MERN stack developer focused on building responsive, full-stack web applications with React.js, Next.js, Node.js, and MongoDB. I enjoy turning complex requirements into clean user experiences and reliable backend systems. From static websites to dynamic, database-driven products, I have worked across UI design, API integration, authentication, and deployment. I am currently open to internships, freelance projects, and growth-oriented software engineering opportunities.";
...
export const PROJECTS = [
  ...
  },
  {
    ...
    description: [
      ...
      "Implemented secure JWT-based authentication and role-based access control for admin and user workflows.",
      "Developed product management, cart functionality, order processing, and payment integration.",
      "Optimized backend queries and maintained a secure API architecture."
    ],
    links: {
