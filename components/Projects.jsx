                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mb-6 flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-primary/10 text-primary rounded-full text-xs font-bold uppercase tracking-wider border border-primary/15"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <div className="flex gap-4">
                    {hasGithub ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-1 py-3 px-6 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-xl font-bold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity no-underline"
                      >
                    ...
                    {hasLiveDemo ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="flex-1 py-3 px-6 bg-primary text-white rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-primary/20 hover:opacity-90 transition-opacity no-underline"
                      >
